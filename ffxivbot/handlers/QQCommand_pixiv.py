...
def search_image(img_url,qq=None):
    ...
    url = 'https://saucenao.com/search.php?db=999&output_type=2&testmode=1&numres=16&url={}'.format(url_img_url)
    ...
    try:
        ...
        if message_content.find("help")==0 or message_content=="":
            msg = "/pixiv $keyword : 搜索关键词$keyword并随机返回\n"+ \
                    ...
                    "Powered by https://api.imjad.cn and https://saucenao.com"
